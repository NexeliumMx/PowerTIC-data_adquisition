...
write_modbus_registers(slave_address=0x1,function_code=0x10,starting_address=0x020D,quantity_of_registers=0x0001,byte_count=0x0002,payload1=0b000000000,)
