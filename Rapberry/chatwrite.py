...
write_modbus(slave_address=0x1,function_code=0x10,starting_address=0x106B,quantity_of_registers=0x2,byte_count=0x2,payload1=0x0000,payload2=0x0000)
...
modbus_read(slave_address=0x01,function_code=0x03,starting_address=0x0106B,quantity_of_registers=0x2)
ser.close()