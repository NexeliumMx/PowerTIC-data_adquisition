...
#time.sleep(5)
modbus_read(slave_address=0x01,function_code=0x03,starting_address=0x209,quantity_of_registers=0x01)
write_modbus_registers(slave_address=0x01,function_code=0x03,starting_address=0x209,quantity_of_registers=0x01,byte_count=0x02,payload1=0b0111111)
modbus_read(slave_address=0x01,function_code=0x03,starting_address=0x209,quantity_of_registers=0x01)
